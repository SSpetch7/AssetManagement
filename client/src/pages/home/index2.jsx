...
const Home = () => {
  ...
  useEffect(() => {
    ...
    HomeService.getStatusNotebook().then((data) => setNotebookStatus(data));
    HomeService.getAllTablet().then((data) => setTabletAll(data));
    HomeService.getStatusTablet().then((data) => setTabletStatus(data));
  }, []);
          ...
          <div>
            ...
            <div className="flex m-3 flex-wrap justify-between gap-1 items-center">
              <div className="flex bg-white h-24 w-48 rounded-xl ">
                <div className="flex items-end pb-6 pl-4"></div>
              ...
              <div className="flex bg-white h-24 w-48 rounded-xl ">
                ...
                <div className="pl-4 flex flex-col self-center  ">
                  <div className="text-2xl  text-gray-400 ">
                    {notebookStatus.asset_status}
                  </div>
                  <div className="text-4xl  font-bold text-gray-500">
                    {notebookStatus.status_number_notebook}
                  </div>
                </div>
              </div>
              <div className="flex bg-white h-24 w-48 rounded-xl ">
                ...
                <div className="pl-4 flex flex-col self-center  ">
                  <div className="text-2xl  text-gray-400 ">
                    {notebookStatus[1].asset_status}
                  </div>
                  <div className="text-4xl  font-bold text-gray-500">
                    {notebookStatus[1].status_number_notebook}
                  </div>
                </div>
              </div>{' '}
              <div className="flex bg-white h-24 w-48 rounded-xl ">
